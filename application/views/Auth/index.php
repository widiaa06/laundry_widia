...
<body class="hold-transition login-page" style="background-color: #94BDF2;">
<div class="login-box">
    ...
    <div class="card-body login-card-body">
      ...
      <form action="" method="post">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block" style="background-color: #94BDF2;">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
