          ...
          <div class="col-lg-12">
            <div class="card card-primary card-outline">
              <div class="card-header">
                ...
                <a href="<?= base_url('member') ?>" class="btn btn-primary" style="background-color:#94BDF2;"><i class="fa fa-"></i> Kembali</a>
             </div>
             </div>
             <div class="card-body">
                ...
                <form method="post">
                  <div class="form-group">
                     <label for="">Id Member</label>
                      ...
                      <div class="form-group">
                        <button type="submit" class="btn btn-primary" style="background-color:#94BDF2;">Submit</button>
                      </div>
                  </div>
                </div>
              </div>
